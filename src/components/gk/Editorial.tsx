...
export default function Editorial() {
  ...
  const [selectedEditorial, setSelectedEditorial] =
    React.useState<EditorialCard | null>(null);
  ...
  const [availableDays, setAvailableDays] = React.useState<Set<string>>(
    new Set(),
  );
  ...
  if (selectedEditorial) {
    return (
      <DetailedEditorial
        ...
        initialShowQuiz={quizItemId === selectedEditorial.id}
      />
    );
  }
          ...
          <div className="flex items-center gap-4 mt-2">
            ...
            <div className="flex items-center gap-6 text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest">
              <button className="flex items-center gap-2 hover:text-[#F59E0B] transition-colors">
                <BookMarked size={14} /> April Summary{" "}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <div className="space-y-8">
          <div className="flex items-center justify-between border-b border-gray-100 dark:border-white/5 pb-4">
            ...
            <span className="text-[10px] font-black text-gray-400 uppercase tracking-widest">
              {
                filteredEditorials.filter((e) => e.source === "The Hindu")
                  .length
              }{" "}
              Editorials
            </span>
        ...
        <div className="space-y-8">
          <div className="flex items-center justify-between border-b border-gray-100 dark:border-white/5 pb-4">
            ...
            <span className="text-[10px] font-black text-gray-400 uppercase tracking-widest">
              {
                filteredEditorials.filter(
                  (e) => e.source === "The Indian Express",
                ).length
              }{" "}
              Editorials
            </span>
          ...
          <div className="space-y-6">
            ...
            {filteredEditorials.filter((e) => e.source === "The Indian Express")
              .length === 0 && (
              <p className="text-gray-500 font-medium py-8 text-center">
                No editorials found for this date.
              </p>
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-wrap gap-3">
        <button className="flex-1 bg-[#060818] dark:bg-white/10 text-white px-6 py-3 rounded-2xl font-bold text-sm hover:bg-gray-800 dark:hover:bg-white/20 transition-all flex items-center justify-center gap-2">
      ...
      <div className="bg-white dark:bg-white/5 p-10 rounded-[3rem] border border-gray-100 dark:border-white/10 space-y-8">
        ...
        <div className="bg-amber-50 dark:bg-[#F59E0B]/10 border border-amber-200 dark:border-[#F59E0B]/20 rounded-2xl p-6">
          ...
          <ul className="space-y-3">
            {cleanEditorialContent(item.content)
              .slice(0, 4)
              .map((para, i) => (
                <li
                  key={i}
