...
const MONTHLY_NEWS: NewsItem[] = [
  {
    ...
    readTime: "12 min",
    summary:
      "A landmark judgment by a seven-judge bench has redefined the scope of a Governor's power to withhold assent to bills passed by the State Legislature.",
    content: `
  ...
  },
  {
    ...
    readTime: "10 min",
    summary:
      "The Ministry of Electronics and IT has released the long-awaited rules for the DPDP Act 2023, outlining strict compliance for data fiduciaries.",
    content: `
  ...
  },
  {
    ...
    readTime: "15 min",
    summary:
      "India has signed a historic trade deal with the European Free Trade Association (EFTA), promising $100 billion in investment over 15 years.",
    content: `
...
const MONTHLY_QUIZ: QuizQuestion[] = [
  {
    id: "q1",
    question:
      "Under which Article of the Indian Constitution does the Governor have the power to grant or withhold assent to a Bill?",
    options: ["Article 161", "Article 200", "Article 213", "Article 123"],
    correctAnswer: 1,
    explanation:
      "Article 200 of the Constitution deals with the assent to Bills passed by the State Legislature. Article 161 is about pardoning powers, 213 is about Ordinances by Governor, and 123 is about Ordinances by President.",
  },
  {
    id: "q2",
    question:
      "The DPDP Act 2023 mandates that data breaches must be reported within how many hours?",
    options: ["24 hours", "48 hours", "72 hours", "96 hours"],
    correctAnswer: 2,
    explanation:
      "The notified rules for the Digital Personal Data Protection Act, 2023, require data fiduciaries to report breaches within 72 hours.",
  },
  {
    id: "q3",
    question:
      "Which of the following countries is NOT a member of the EFTA bloc?",
    options: ["Switzerland", "Norway", "Iceland", "Austria"],
    correctAnswer: 3,
    explanation:
      "EFTA consists of four countries: Switzerland, Norway, Iceland, and Liechtenstein. Austria is a member of the European Union (EU), not EFTA.",
  },
];
        ...
        <div className="space-y-5 sm:space-y-6">
          ...
          <div className="prose prose-sm sm:prose-lg dark:prose-invert max-w-none">
            {selectedNews.content.split("\n").map((paragraph, i) => (
              <p
                key={i}
                className="text-gray-600 dark:text-gray-400 leading-relaxed mb-3 sm:mb-4 text-sm sm:text-base"
              >
                {paragraph.trim()}
              </p>
            ))}
    ...
    <div className="space-y-8 sm:space-y-12">
      ...
      <div className="flex flex-col gap-4 sm:gap-6">
        ...
        <div className="flex bg-gray-100 dark:bg-white/5 p-1.5 rounded-2xl border border-gray-200 dark:border-white/10 self-start max-w-full overflow-x-auto no-scrollbar">
          ...
          >
            <Zap size={16} />{" "}
            <span className="hidden sm:inline">Monthly Quiz</span>
          ...
          >
            {!showResult ? (
              <div className="bg-white dark:bg-white/5 rounded-[2rem] sm:rounded-[3rem] border border-gray-100 dark:border-white/10 p-5 sm:p-10 space-y-6 sm:space-y-10 shadow-2xl">
                ...
                <div className="flex items-start sm:items-center justify-between gap-3">
                  <div className="space-y-1 flex-1">
                    <p className="text-[10px] font-black text-[#F59E0B] uppercase tracking-[0.2em]">
                      Question {currentQuestion + 1} of {MONTHLY_QUIZ.length}
                    </p>
                    <div className="h-1.5 w-full bg-gray-100 dark:bg-white/5 rounded-full overflow-hidden">
                      <motion.div
                        ...
                        initial={{ width: 0 }}
                        animate={{
                          width: `${((currentQuestion + 1) / MONTHLY_QUIZ.length) * 100}%`,
                        }}
                      />
                    </div>
                  </div>
                ...
                <div className="space-y-3">
                  {MONTHLY_QUIZ[currentQuestion].options.map((option, idx) => {
                    const isCorrect =
                      idx === MONTHLY_QUIZ[currentQuestion].correctAnswer;
                ...
                {isAnswered && (
                  ...
                  >
                    {currentQuestion + 1 === MONTHLY_QUIZ.length
                      ? "Finish Quiz"
                      : "Next Question"}
                    <ArrowRight size={20} />
                  </motion.button>
              ...
              <div className="bg-white dark:bg-white/5 rounded-[2rem] sm:rounded-[3rem] border border-gray-100 dark:border-white/10 p-8 sm:p-16 text-center space-y-6 sm:space-y-8 shadow-2xl">
                ...
                <div className="space-y-2">
                  <h2 className="text-2xl sm:text-4xl font-black text-[#060818] dark:text-white">
                    Quiz Completed!
                  </h2>
                  <p className="text-sm sm:text-base text-gray-500 dark:text-gray-400 font-medium">
                    Great effort on staying updated with April's news.
                  </p>
                </div>
