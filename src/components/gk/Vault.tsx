        ...
        <div className="space-y-8 sm:space-y-12">
              ...
              <section className="text-center py-10 sm:py-16 bg-white dark:bg-white/5 rounded-[2rem] sm:rounded-[3rem] border border-gray-100 dark:border-white/5">
                      <div className="max-w-2xl mx-auto px-4 sm:px-6">
                                <h2 className="text-3xl sm:text-5xl font-black text-[#060818] dark:text-white mb-4 sm:mb-6 leading-tight">
                                            Stop reading. <span className="text-[#F59E0B]">Start learning.</span>
                                </h2>
                                ...
                                <div className="flex flex-wrap justify-center gap-3 sm:gap-4">
                                            ...
                                            <button
                                                          ...
                                                          >
                                                          <span className="flex items-center gap-2"><BookOpen size={18} /> Read Summary</span>
                                            </button>
                                </div>
                      </div>
              </section>
          ...
          {/* Highlights */}
              <section className="space-y-5 sm:space-y-8">
                      <h3 className="text-xl sm:text-2xl font-black dark:text-white">Today&#39;s Highlights</h3>
                      ...
                      <motion.div
                                    ...
                                    <h4 className="text-base sm:text-xl font-bold mb-2 text-[#060818] dark:text-white">{item.title}</h4>
                                    <p className="text-sm sm:text-base text-gray-500 dark:text-gray-400">{item.summary}</p>
                                    <p className="text-[10px] font-bold text-gray-400 mt-2 uppercase tracking-widest">{item.time} read</p>
                      </motion.div>
                    ))}
                      </div>
              </section>
