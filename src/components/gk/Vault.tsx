  ...
  const highlights = [
    {
      ...
      time: "2 mins",
      summary:
        "The Constitution Bench has reserved its judgment on the validity of the Electoral Bonds scheme.",
    },
    {
      id: "2",
      title: "Israel-Palestine Conflict: UN Resolution",
      category: "International Relations",
      time: "3 mins",
      summary: "A deep dive into the latest UN General Assembly resolution.",
    },
    {
      id: "3",
      title: "New Digital Competition Bill",
      category: "Economy",
      time: "2 mins",
      summary:
        "How the proposed bill aims to regulate Big Tech companies in India.",
    },
  ];
          ...
          {highlights.map((item, idx) => (
            ...
            >
              <div className="flex justify-between items-start mb-3">
                <span className="text-[10px] font-black px-3 py-1 rounded-full bg-gray-50 dark:bg-white/10 text-gray-400 uppercase tracking-widest">
                  {item.category}
                </span>
                <button
                  onClick={(e) => {
              ...
              <h4 className="text-base sm:text-xl font-bold mb-2 text-[#060818] dark:text-white">
                {item.title}
              </h4>
