...
export default function GKLayout({ children, activeTab, setActiveTab }: GKLayoutProps) {
  ...
  return (
    <div
      className={`gk-portal${theme === 'dark' ? ' dark' : ''} min-h-screen bg-white dark:bg-[#060818] font-sans text-[#060818] dark:text-white transition-colors duration-300 relative`}
    >
      {/* Toast */}
      {toast && (
        <motion.div
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-20">
            ...
            >
              ...
              <span className="text-xl font-black tracking-tighter text-[#060818] dark:text-white">
                CLAT TRIBE
              </span>
            </div>
            ...
            <div className="hidden lg:flex items-center space-x-8">
              ...
              <div className="relative ml-4">
                ...
                >
                  ...
                  <span className="text-sm font-bold">Abhinav</span>
                  <ChevronDown
                    size={14}
                ...
                {isProfileOpen && (
                  <div className="absolute right-0 mt-2 w-48 bg-white dark:bg-[#060818] rounded-2xl shadow-xl border border-gray-100 dark:border-white/10 py-2 overflow-hidden">
                    <button
                      onClick={() => {
                    ...
                    <button
                      onClick={() => {
                        ...
                        setTimeout(() => {
                          localStorage.removeItem('gk_isLoggedIn');
