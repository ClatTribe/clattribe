      ...
      >
        ...
        <div className="space-y-4">
          <button
            ...
            className="w-full bg-white text-[#060818] py-4 rounded-2xl font-black flex items-center justify-center gap-3 hover:bg-gray-100 transition-all shadow-xl shadow-white/5 group"
          >
