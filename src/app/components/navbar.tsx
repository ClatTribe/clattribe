...
export default function Navbar({ scrollToSection }: NavbarProps) {
  ...
  // scrollToSection prop is kept for API compatibility but is no longer
  // used by the navbar after the Flashcards button was replaced with
  // a "Daily GK" link to the in-portal GK section.
