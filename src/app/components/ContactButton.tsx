  ...
  return (
    <div ref={containerRef} className="fixed bottom-4 right-6 z-50">
      ...
      >
        ...
        <button
          onClick={handleCall}
          className="flex items-center gap-2 bg-white hover:bg-slate-50 text-gray-800 px-3 py-2 rounded-full shadow-lg hover:shadow-xl transition-all duration-200 group border border-slate-300 animate-slideUp"
          style={{ animationDelay: '0.1s' }}
        >
          <div className="w-8 h-8 bg-gradient-to-br from-[#1E293B] to-[#0f172a] rounded-full flex items-center justify-center group-hover:scale-110 transition-transform">
      ...
      <button
        ...
        className={`relative bg-gradient-to-r from-[#F59E0B] to-[#F59E0B] hover:from-[#fbbf24] hover:to-[#D97706] text-white shadow-xl hover:shadow-2xl transition-all duration-300 flex items-center gap-2 group rounded-full
