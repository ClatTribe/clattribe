...
import NLUEnquiryForm from '../components/NLUEnquiryForm';
...
const App: React.FC = () => {
  ...
  return (
    <>
      {showForm && <NLUEnquiryForm onSuccess={() => { setHasAccess(true); setShowForm(false); }} />}
      
      <div className={`min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 font-sans selection:bg-indigo-100 dark:selection:bg-indigo-900/30 transition-all duration-500 ${showForm ? 'blur-sm pointer-events-none' : ''}`}>
